...
results["sets"]["APS_no_calib"] = APS_no_calib
results["opt_lambda"]["APS_cond_cvg_satisfaction"] = lambda_cond_cvg_satisfaction
results["sets"]["APS_cond_cvg_satisfaction"] = APS_cond_cvg_satisfaction
results["opt_lambda"]["APS_cond_cvg_satisfaction_zero"] = lambda_cond_cvg_satisfaction_zero
results["sets"]["APS_cond_cvg_satisfaction_zero"] = APS_cond_cvg_satisfaction_zero
results["opt_lambda"]["APS_mean_cond_cvg"] = lambda_mean_cond_cvg
results["sets"]["APS_mean_cond_cvg"] = APS_mean_cond_cvg
results["opt_lambda"]["APS_marg_cvg"] = lambda_marg_cvg
results["sets"]["APS_marg_cvg"] = APS_marg_cvg

#############################
#save results
#############################
os.makedirs(os.path.join(root_path, "all_sets", "unknown validity", dataset, model, model_seed_str, gamma_str), exist_ok=True) 
with open(os.path.join(root_path, "all_sets", "unknown validity", dataset, model, model_seed_str, gamma_str, f"APS_alphaCP_{alpha_cp_str}_cond_{cond_cvg_thr}_seed_{split_seed}.pkl"), 'wb') as f:
